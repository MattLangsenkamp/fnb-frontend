...
export default function AddUser() {
  const [signUp, { data: mutData, error: mutationError }] = useMutation(
    SIGN_UP
  );
  ...
  if (mutData) {
    ...
    if (mutData.signUp.message === "sign up successful") {
        ...
        >
          {({
            ...
            <Form onSubmit={handleSubmit}>
              ...
              <Form.Group as={Col} md="6" controlId="validationFormik02a">
